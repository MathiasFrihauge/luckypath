                            ...
                            <div class="bonus">
                                ...
                                <ul>
                                    <template v-if="item.whatsappLink">
                                        <li>
                                            <a :href="item.whatsappLink" @click.prevent="openModalSms(item.whatsappLink)" target="_blank"><img src="/images/whatsapp.png" alt=""></a>
                                        </li>
                                    </template>
...
export default {
    ...
    methods: {
        openModal(casino) {
            ...
            console.log(this.casinoClicked)
            this.showModal = true;
        },
        closeModal() {
            console.log('Close modal innn');
